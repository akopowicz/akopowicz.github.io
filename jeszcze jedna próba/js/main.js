(function(){
    ...
    let starResizeChairs = setInterval(resizeChairs, 1000);
    ...
    const moveChair = (e) => {
        ...
        clearInterval(starResizeChairs);
    ...
    const endMove = (e) => {
        ...
        let mainImageX = mainImage.offsetLeft;
        let mainImageY = mainImage.offsetTop;
        let mainImageRight = mainImageX + mainImage.offsetWidth;
        let mainImageBottom = mainImageY + mainImage.offsetHeight;

...
let skill_balls_animation_reverse = document.querySelectorAll(".skill_ball_animation_reverse");
...
const sectionAnimationProjects = new IntersectionObserver(animateIntersectionProject, { threshold: .22 });
...
const sectionSkills = new IntersectionObserver(skillsBallAnimationsObserver, { threshold: .3 });
...
const headerObserver = new IntersectionObserver(headerAnimations, { threshold: .3 });
...
const contactObserver = new IntersectionObserver(contactShow, { threshold: .3 });
